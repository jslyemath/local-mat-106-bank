...
\begin{enumerate}
    ...
    \item \tfleft[p1_ans]{$\VAR{p1_prob}$}\\[4ex]

    \item \tfleft[p2_ans]{$\VAR{p2_prob}$}\\[4ex]

    \item \tfleft[p3_ans]{$\VAR{p3_prob}$}\\[4ex]

    \item \tfleft[p4_ans]{$\VAR{p4_prob}$}\\[4ex]

    \item \tfleft[p5_ans]{$\VAR{p5_prob}$}\\[4ex]

    \item \tfleft[p6_ans]{$\VAR{p6_prob}$}\\[4ex]

    \item \tfleft[p7_ans]{$\VAR{p7_prob}$}\\[4ex]

    \item \tfleft[p8_ans]{$\VAR{p8_prob}$}\\[4ex]
