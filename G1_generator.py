...
def generate(**kwargs):
        ...
        'div-dec-standard-1':
            {
                ...
                'thinking': "The student may have been thinking that we only need to move the decimals until the dividend is a whole number. They may have also thought that remainders and amounts after the decimal point are interchangeable.",
    ...
    version_name = random.choice(list(versions))
